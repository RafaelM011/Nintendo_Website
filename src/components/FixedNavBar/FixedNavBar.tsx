    ...
    return(
        <>
            <div className="bg-white flex">
                {/* <img className="w-[105px] h-[52px]" src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Nintendo.svg/2560px-Nintendo.svg.png" alt="nintendo logo"/> */}
                ...
                <div className="w-full flex justify-between items-center">
                    <div className="min-w-[450px] h-[34px] mx-4 border-b-2 border-main flex gap-2">
                        <img className="w-[28px]" src={Magnifier_Icon} alt="search icon"/>
                        <input className="w-full focus:outline-none" placeholder="Search"/>
                        <select className="text-main focus:outline-none">
