        ...
        <>
            <div className="bg-white flex">
                ...
                <div className="w-full flex justify-between items-center border-b-[1px] border-main">
                    <div className="min-w-[450px] h-[34px] mx-4 border-b-2 border-main flex gap-2">
            ...
            <div className="bg-white flex justify-center gap-8 items-center h-[52px] border-b-[1px] border-main">
