    ...
    return(
        <header className="sticky">
            <div className="bg-white flex">
                <div className="bg-[#e60012] min-w-[105px] h-[52px] flex place-content-center">
                ...
                <div className="w-full flex justify-between items-center border-b-[1px] border-main">
                    <div className="min-w-[350px] h-[34px] mx-4 border-b-2 border-main flex gap-2">
                        ...
                        <select className="text-main focus:outline-none hover:cursor-pointer">
                    ...
                    <div className="w-[520px] h-[48px] flex justify-around items-center font-bold text-main">
                        <div className="flex items-center gap-1">
                            ...
                            <button className="hover:text-secundary hover:cursor-pointer">Support</button>
                        </div>
                        <div className="flex items-center gap-1">
                            <img className="w-[20px]" src={Wish_List_Icon} alt="wish list button"/>
                            <button className="hover:text-secundary hover:cursor-pointer">Wish List</button>
                        </div>
                        <div className="flex items-center gap-1">
                            <img className="w-[20px]" src={Cart_Icon} alt="cart button"/>
                            <button className="hover:text-secundary hover:cursor-pointer">Cart</button>
                        </div>
                        <div className="flex items-center gap-1">
                            <img className="w-[20px]" src={Login_Icon} alt="login button"/>
                            <button className="hover:text-secundary hover:cursor-pointer">Log in / Sign Up</button>
                        </div>

                    </div>
                </div>
            </div>
            <div className="bg-white flex justify-center gap-8 items-center w-full h-[52px] border-b-[1px] border-main">
                <button className="h-5/6 pt-3 text-main font-bold border-b-4 border-secundary"> My Nintendo Store </button>
                <button className="h-5/6 pt-3 text-main font-bold "> Games </button>
                <button className="h-5/6 pt-3 text-main font-bold "> Nintendo Switch </button>
                <button className="h-5/6 pt-3 text-main font-bold "> News & Events </button>
                <button className="h-5/6 pt-3 text-main font-bold "> Play Nintendo </button>
            </div>
        </header>
    )
}