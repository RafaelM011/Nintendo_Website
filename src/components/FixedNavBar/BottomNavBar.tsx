export const BottomNavBar = (): JSX.Element => {
    return(
        <div>
            ...
            <div className="fixed bottom-[150px] left-0 right-0 w-full h-[60px]">
                <div className="w-7/12 px-4 pt-6 bg-[#E8E8E8] rounded-2xl h-[110px] mx-auto relative top-8 -z-10 flex justify-between items-start">
                ...
                <div className="bg-white w-7/12 mx-auto rounded-full flex justify-evenly">
                    <svg 
